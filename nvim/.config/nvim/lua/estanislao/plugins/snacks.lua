return {
                ...
                sections = {
 {
        ...
        keys = {
            ...
            { "<leader>cR", function() require("snacks").rename.rename_file() end, desc = "Rename current file"},
            ...
            { "<leader>gg", function() require("snacks").lazygit.log() end, desc = "Lazygit logs" },
            { "<leader>gb", function() require("snacks").git.blame_line() end, desc = "Blame line"},
            { "<leader>gf", function() require("snacks").picker.git_log_file() end, desc = "Git Log File" },
            { "<leader>gB", function() require("snacks").picker.git_branches({ layout = "select" }) end, desc = "Git branches"},
            ...
            { "<leader>pc", function() require("snacks").picker.colorschemes({ layout = "ivy" }) end, desc = "Pick colorschemes" },
            { "<leader>ph", function() require("snacks").picker.help({ layout = "ivy" }) end, desc = "Help pages" },
            { "<leader>pm", function() require("snacks").picker.man({ layout = "ivy" }) end, desc = "Man pages" },
        },
    },
    {
